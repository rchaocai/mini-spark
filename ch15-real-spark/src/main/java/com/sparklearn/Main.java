...
public final class Main {
    ...
    public static void main(String[] args) {
        // ==================== Part A: 跑一段 pipeline，看 job 怎么跑完 ====================
    ...
    /**
     * 第 9 章讲过两层恢复为什么这么设计；这里把它们跑起来，看运行时的样子。
     *
     * <p>第一层：Task 抛异常，DAGScheduler 在事件循环里只重试这一个 Task。
    ...
    private static void runFaultRecovery() {
        ...
        // --- 第一层：Task 抛异常 → DAGScheduler 重试同一个 Task ---
        System.out.println("\n【第一层】Task 抛异常 → DAGScheduler 重试同一个 Task");
