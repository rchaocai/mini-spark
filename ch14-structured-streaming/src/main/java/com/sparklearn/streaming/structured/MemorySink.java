 ...
 * 将所有批次的结果保存在内存中，方便验证。
 *
 * <p>参考 Spark 源码：{@code org.apache.spark.sql.execution.streaming.MemorySink}
 *（sql/core/.../execution/streaming/memory.scala）。
 *
 ...
 * </ul>
 *
 * <p>对应 Spark MemorySink 的实现：
 * <pre>
 *   outputMode match {
 *     case Append | Update => batches.append(...)
 *     case Complete         => batches.clear(); batches.append(...)
 *   }
 * </pre>
 */
